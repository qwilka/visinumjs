// node -i -e "$(< test_vn-node.js)"
// node -r esm test_vn-node.js

const fs = require("fs");

const VnNode = require("./vn-node2");
...
switch (choice) {
    ...
    default:
        ...
        let node2 = new VnNode("node2", rootnode);
        ...
        let node3 = new VnNode("node2", rootnode);  // duplicate name
